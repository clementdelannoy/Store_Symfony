...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/cart/category')) {
            // cart_category_list
            ...
            // cart_category_edit
            if (0 === strpos($pathinfo, '/cart/category/edit') && preg_match('#^/cart/category/edit/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
            ...
            if (0 === strpos($pathinfo, '/cart/category/delete') && preg_match('#^/cart/category/delete/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
        ...
        elseif (0 === strpos($pathinfo, '/cart/product')) {
            ...
            // cart_product_add
            if ('/cart/products/add' === $pathinfo) {
                return array (  '_controller' => 'CartBundle\\Controller\\ProductController::addAction',  '_route' => 'cart_product_add',);
            }

            // cart_product_edit
            if (0 === strpos($pathinfo, '/cart/product/edit') && preg_match('#^/cart/product/edit/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
            ...
            // cart_product_delete
            if (0 === strpos($pathinfo, '/cart/product/delete') && preg_match('#^/cart/product/delete/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'cart_product_delete')), array (  '_controller' => 'CartBundle\\Controller\\ProductController::deleteAction',));
                if (!in_array($canonicalMethod, array('GET'))) {
                    $allow = array_merge($allow, array('GET'));
                    goto not_cart_product_delete;
                }

                return $ret;
            }
            not_cart_product_delete:
        ...
        // hellopage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<prenom>[^/]++)$#sD', $pathinfo, $matches)) {
