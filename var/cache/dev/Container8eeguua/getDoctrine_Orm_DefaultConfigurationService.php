...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/src/CartBundle/Entity'), 2 => ($this->targetDirs[3].'/src/UserBundle/Entity')));

$a->addDriver($b, 'AppBundle\\Entity');
$a->addDriver($b, 'CartBundle\\Entity');
$a->addDriver($b, 'UserBundle\\Entity');
...
$instance->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'CartBundle' => 'CartBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
