...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/CartBundle/Entity'), 1 => ($this->targetDirs[3].'/src/UserBundle/Entity')));
...
$instance->setEntityNamespaces(array('CartBundle' => 'CartBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
